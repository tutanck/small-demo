...
0. This project is a demo project for [the smallapi platform](https://smallapi.io/){:target="_blank"}. It works by querying an api deployed from the smallapi platform. Start by creating and deploying an api on smallpi by following the following [tutorial](https://smallapi.io/docs/page/quick-start){:target="_blank"}.
