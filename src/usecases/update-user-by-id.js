...
// Update the first created user's age and email
const updatedUser = await api.updateUserById(firstCreatedUserId, {
  age: firstCreatedUser.age + 1,
  email: firstCreatedUser.email.toLowerCase(),
});
